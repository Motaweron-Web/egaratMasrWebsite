...
<content>
    ...
    <section class="mainBanner">
        ...
        <ul>
            ...
            <li>
                <a href="#!" class="active"> حساب جديد </a>
            </li>
        </ul>
        <figure>
            <svg
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 offset-lg-3 offset-md-3">
                    <div class="formBox">
                        ...
                        <div class="Aform form-style" action="!">
                            ...
                            <div class="text-center mb-3">
                                <button class="btn" id="btn-register" >تسجيل الدخول</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $.ajax({
            ...
            success:function(res){
               ...
               //     location.reload();
                ...
                {
                    swal("  انشاء حساب ", "يرجي التاكد من البيانات المدخلة", "error", {button: "حسناً",});

                }
                else
                {
                    swal("  انشاء حساب ", "رجاء المحاولة لاحقا", "error", {button: "حسناً",});
                }
