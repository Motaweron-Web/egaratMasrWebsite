...
<div class="container">
    ...
    <div class="welcome-container">
        ...
        <img src="{{asset('assets/admin/images/house.gif')}}" alt="login" style="max-height: 300px;mix-blend-mode: multiply ; width: 300px; border-radius: 50%; margin-right:60px; margin-top: 40px" >
    </div>
</div>
